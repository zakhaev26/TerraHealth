...
res.render('bmiresult.ejs',{stylesheet:'/stylesbmi.css',bmi:bmi,suggestion:suggestion})
}) 
...
app.post('/bmicalc', (req, res) => {
   const weight = Number(req.body.weight);
    ...
    if(bmi<18.5){
        suggestion=`Underweight (BMI < 18.5):If you are underweight, it's important to focus on gaining weight in a healthy way.
